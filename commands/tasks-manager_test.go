...
import (
	...
	"github.com/Josh012422/gocharm/bridge"
	"github.com/spf13/viper"
	homedir "github.com/mitchellh/go-homedir"
)

/* Vars already defined in tasks-manager.go
...
func TestAdd(t *testing.T) {
	filetype := bridge.GetFiletype()
	home, errHome := homedir.Dir()

	if errHome != nil {                                                            t.Error(errHome)                                               }
...
func TestAddItem(/*content string, idRaw int*/t *testing.T) {
	viper.New()
	filetype := bridge.GetFiletype()
	home, errHome := homedir.Dir()
...
func TestView(t *testing.T/*id string*/) {
	viper.New()
	filetype := bridge.GetFiletype()
	home, errHome := homedir.Dir()
...
func TestComplete(t *testing.T/*id string*/) {
	viper.New()
	filetype := bridge.GetFiletype()
	home, errHome := homedir.Dir()
...
func TestCompleteItem(t *testing.T/*taskId, itemId string*/) {
	viper.New()
	filetype := bridge.GetFiletype()
	home, errHome := homedir.Dir()
